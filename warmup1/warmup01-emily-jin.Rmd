...
#2. Cooking Recipe 
##Baked Buffalo Wings 
![](https://www.jessicagavin.com/wp-content/uploads/2018/01/crispy-baked-buffalo-wings-5.jpg)
Who doesn't love Buffalo wings? Nice wings are popular throughout the year, and you need to know how to make good ones if you are a real wing lover. 
...
![](https://www.seriouseats.com/recipes/images/2017/01/20150127-buffalo-wings-oven-fried-7.jpg)
You can always make your Buffalo wings to taste better with blue cheese dressing. Combine all ingredients listed below in a bowl and stir until combined, but cheese is still lumpy. Season well with salt and pepper. Dressing keeps refrigerated for 5 to 6 days.
...
$$d(\mathbf{p}, \mathbf{q}) = d(\mathbf{q}, \mathbf{p}) = \sqrt{(q_1-p_1)^2 + (q_2-p_2)^2 + \cdots + (q_n-p_n)^2}\\ = \sqrt{\displaystyle\sum_{i=1}^{n} (q_i-p_i)^2}.$$
...
$$ d(\mathbf {p} ,\mathbf {q} )=\sqrt {(q_1-p_1)^1 + (q_2-p_2)^2}.$$
...
$$\sqrt {r_1^2+r_2^2-2r_1r_2\cos(\theta _1-\theta _2)}.$$
